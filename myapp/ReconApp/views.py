...
def index(request):
    ...
    if start_date and end_date and fuel_agent:
        ...
        # ambil data dari missing invoices in occ
        missing_invoices_in_occ = MissingInvoiceInOcc.objects.all()
    ...
    total_missing_invoices_in_occ = sum(item.uplift_in_lts for item in missing_invoices_in_occ)
    ...
    context = {
        ...
        'total_missing_invoices_in_vendor': total_missing_invoices_in_vendor,
        'missing_invoices_in_occ': missing_invoices_in_occ,
        'total_missing_invoices_in_occ': total_missing_invoices_in_occ,
    }   
